...
OBJECTS = nrf_comm.o $(COMMON_OBJECTS) onewire.o
...
## BUILD
## ==================================================================
all: $(TARGET) nrf_comm.hex nrf_comm.lss nrf_comm.size
...
NODE_SOURCES = spilib.c nrf_comm.c onewire.c Mirf.cpp
...
.PHONY: clean
clean:
	rm -rf $(OUTDIR)/$(TARGET) $(DEPDIR)/*.d $(OUTDIR)/*.o $(OUTDIR)/*.hex $(OUTDIR)/*.eep $(OUTDIR)/*.lss $(OUTDIR)/*.map
